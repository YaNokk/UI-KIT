...
with component-local pixel offsets, negative margins, asymmetric padding or
size-specific geometry.

The `Foundations / SingleLineControlTypography / Matrix` Storybook story covers `sm`, `md` and `lg`
