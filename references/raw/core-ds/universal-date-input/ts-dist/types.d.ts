import { type ChangeEvent, type FocusEvent, type ForwardRefExoticComponent, type KeyboardEvent, type MouseEvent, type PropsWithoutRef, type RefAttributes, type RefObject } from 'react';
...
export interface BaseUniversalDateInputProps extends Omit<InputProps, 'onChange' | 'wrapperRef' | 'dataTestId' | 'value' | 'defaultValue'> {
    /**
     ...
     */
    onInputChange?: (event: ChangeEvent<HTMLInputElement> | null, payload: {
        value: string;
    }) => void;
    /**
...
export interface InnerDateRangeInputProps extends Omit<InnerDateInputProps, 'onChange' | 'value' | 'defaultValue'> {
    /**
     *  Диапазон дат
     */
    value?: {
...
type PrivateProps = 'platform' | 'withTime' | 'open' | 'calendarRef' | 'inputWrapperRef' | 'wrapperHandlers' | 'onPickerClick';
type Never<T> = {
    [P in keyof T]?: never;
};
type WithPickerRequiredProps = Required<Pick<BaseUniversalDateInputProps, 'Calendar'>>;
type WithPickerNotRequiredProps = Pick<BaseUniversalDateInputProps, 'calendarProps' | 'popoverProps' | 'onCalendarOpen' | 'onCalendarClose' | 'calendarOpen' | 'onCalendarOpenChange'>;
...
export type UniversalDateInputConditionalProps = ({
    view: 'date';
    picker: true;
} & WithPickerProps & Pick<InnerDateInputProps, 'onChange' | 'wrapperClassName' | 'value' | 'defaultValue'>) | ({
    view: 'date';
    picker?: false;
} & NoPickerProps & Pick<InnerDateInputProps, 'onChange' | 'wrapperClassName' | 'value' | 'defaultValue'>) | ({
    view: 'date-time';
    picker: true;
} & WithPickerProps & Pick<InnerDateInputProps, 'onChange' | 'wrapperClassName' | 'value' | 'defaultValue'>) | ({
    view: 'date-time';
    ...
    view: 'date-range';
    picker: true;
} & WithPickerProps & Pick<InnerDateRangeInputProps, 'onChange' | 'wrapperClassName' | 'rangeBehavior' | 'value' | 'defaultValue'>) | ({
    view: 'date-range';
    picker?: false;
} & NoPickerProps & Pick<InnerDateRangeInputProps, 'onChange' | 'wrapperClassName' | 'value' | 'defaultValue'>) | ({
    view: 'time';
    picker?: never;
    minDate?: never;
    maxDate?: never;
    Calendar?: never;
} & Pick<InnerTimeInputProps, 'onChange' | 'value' | 'defaultValue'>);
export type UniversalDateInputProps = Omit<BaseUniversalDateInputProps, PrivateProps | keyof WithPickerProps> & UniversalDateInputConditionalProps;
export type UniversalDateInputMobileProps = Omit<UniversalDateInputProps, 'breakpoint' | 'defaultMatchMediaValue'> & UniversalDateInputConditionalProps;
export type UniversalDateInputDesktopProps = Omit<UniversalDateInputProps, 'breakpoint' | 'defaultMatchMediaValue'> & UniversalDateInputConditionalProps;
export {};
