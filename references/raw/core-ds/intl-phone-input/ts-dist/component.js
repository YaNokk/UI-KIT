 ...
 */
export const IntlPhoneInput = forwardRef(({ disabled = false, readOnly = false, hideCountrySelect = false, canBeEmptyCountry = false, ruNumberPriority = false, clear = false, size = 56, colors = 'default', options = [], countries = getCountries(), clearableCountryCode = true, maxDialCodeLength = MAX_DIAL_CODE_LENGTH, className, value, onChange, onCountryChange, defaultCountryIso2 = 'ru', preventFlip, inputProps, maxPhoneLen = DEFAULT_MAX_PHONE_LEN_BY_COUNTRY, ...restProps }, ref) => {
    ...
    return (React.createElement(InputAutocompleteDesktop, { ...restProps, ref: ref, inputProps: {
